...
void setup() {
  ...
  J5_stepper.setMaxSpeed(20000);
  J5_stepper.setAcceleration(150000);
  J6_stepper.setMaxSpeed(20000);
  J6_stepper.setAcceleration(150000);
  ...
  J6_driver.microsteps(8);          // Set microsteps to 1/16th
...
void loop() {
 ...
 /* if(Message_ID == "J6"){
  ...
  //Serial.println(j5position);
        if (J6_stepper.distanceToGo() == 0)
      J6_stepper.moveTo(j5[0]);
